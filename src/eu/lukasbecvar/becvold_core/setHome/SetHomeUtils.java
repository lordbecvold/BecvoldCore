...
public class SetHomeUtils {
    ...
    public SetHomeUtils(Main instance) {
    ...
    public Location getHomeLocation(Player player) {
        return new Location(Bukkit.getWorld(instance.homes.getString("Homes." + player.getUniqueId().toString() + ".World")), instance.homes.getDouble("Homes." + player.getUniqueId().toString() + ".X"), instance.homes.getDouble("Homes." + player.getUniqueId().toString() + ".Y"), instance.homes.getDouble("Homes." + player.getUniqueId().toString() + ".Z"), instance.homes.getLong("Homes." + player.getUniqueId().toString() + ".Yaw"), instance.homes.getLong("Homes." + player.getUniqueId().toString() + ".Pitch"));
    }
